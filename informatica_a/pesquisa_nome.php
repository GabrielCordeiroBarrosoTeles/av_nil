 ...
 <?php 
    ...
    <div class="z-depth-4" id="tabela">
        <table class="responsive-table z-depth-4 centered #00695c teal darken-3">
            <center><h3><i class="material-icons  medium">search</i>Pesquisar nome </h3></center>
            
            <div class="container">
                <div class="col s12" id="kk">  
                    <div class="row">
                        <form action="pesquisa_nome.php" method="post">
                            <div class="input-field col s12">
                                <input placeholder="Ex: HHH3366" id="first_name" name="nome_func" type="text" class="validate">
            ...
            <thead class="highlight red white-text">
              ...
              <?php 
                ...
                $consultar= "SELECT * FROM ordemservico WHERE funcionario LIKE '%$nome_func%' OR nome LIKE '%$nome_func%'";
        ...
        <div class="container  z-depth-4">
            <div class="row">
            	<div class="col l6 s12">
                	<center><h5 class="white-text">Davi Lourenço Desenvolvimento de Sistemas WEB</h5></center>
              </div>
